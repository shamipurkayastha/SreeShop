...
class ManufactureController extends Controller
{
    ...
    public function save_manufacture(Request $request)
    {
                    ...
                    Session::put('messsage','Manufacture added successfuly !! ');
    ...
    public function all_manufacture()
         ...
         public function unactive_manufacture($manufacture_id)
        {
                ...
                Session::put('messsage','Manufacture unactive successfuly !! ');
                return Redirect::to('/all_manufacture');
        }
          public function active_manufacture($manufacture_id)
        {
                ...
                Session::put('messsage','Manufacture active successfuly !! ');
                return Redirect::to('/all_manufacture');
        }
        ...
        public function update_manufacture(Request $request,$manufacture_id)
        {
            ...
            DB::table('tbl_manufacture')
              ...
              Session::get('messsage','Manufacture update successfully !!');
              return Redirect::to('/all_manufacture');
