					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{URL::to($product_by_details->product_image)}}" style="height: 250px;" alt="" />
								<h3>ZOOM</h3>
							</div>
							</div>
								<div class="col-sm-7">
						...
						<img src="{{URL::to('frontend/images/product-details/rating.png')}}" alt="" />
								...
								<input name="qty" type="number" value="1" max="{{$product_by_details->stock}}" />
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									<ul>
										...
										<li><a href=""><i class="fa fa-calendar-o"></i>07 April 2019</a></li>
									</ul>
